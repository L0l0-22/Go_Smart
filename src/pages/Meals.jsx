...
export default function Meals() {
  ...
  return (
    <div className="py-8 mt-20 container w-[90%] mx-auto">
        <div className='text-center'>
        <h1 className="text-4xl font-bold text-forest mb-2">Your Meals, Your Way</h1>
        <p className="text-sm text-gray-600 mb-10">
        Choose what fuels you best — flexibility built in.
        </p>
        </div>
      ...
      <div className="flex flex-wrap justify-center gap-8">
        {initialMenu.map((item) => {
          ...
          return (
            <div
              key={item.id}
              className="bg-white w-full sm:w-[45%] lg:w-[25%] rounded-xl shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-105  will-change-transform "
            >
              <img
                loading="lazy"
                src={item.image}
              ...
              <div className="p-4">
                ...
                <button
                    ...
                    } font-semibold px-3 py-2 w-full rounded-full text-md flex items-center justify-center gap-2 hover:bg-beige hover:text-forest transition`}
                    >
